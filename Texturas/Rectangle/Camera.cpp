...
void Camera::SetPerspective(float nearPlane, float farPlane, float fieldOfView, float aspectRatio) //2d
{
	_projectionMatrix = glm::perspective(glm::radians(fieldOfView), aspectRatio, nearPlane, farPlane);
}

void Camera::SetOrthographic(float size, float aspectRatio) //3d
{
