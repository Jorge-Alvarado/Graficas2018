...
void Transform::UpdateModelMatrixPosition() { //En la diagonal esta la escala y en la ultima columna esta los ejes
...
void Transform::UpdateModelMatrixRotationScale() {
	...
	UpdateModelMatrixPosition();
	UpdateLocalVector();  //Solo se calculan si se ha hecho una rotación

}

void Transform::UpdateLocalVector() {

	glm::mat4 rotationMatrix = glm::mat4_cast(_rotation); //La matrix de rotacion solo se queda con la rotacion
